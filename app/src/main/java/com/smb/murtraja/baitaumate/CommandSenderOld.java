...
public class CommandSenderOld implements Runnable {
    ...
    TODO: CommandSenderOld should automatically spawn a new thread and the calling thread must be notified via callback
    The usage should be as simple as CommandSenderOld.send(command, device)
    ...
    public CommandSenderOld(int colourToSet, IOnCommandSentListener onCommandSentListener) {
